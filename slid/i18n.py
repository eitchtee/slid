...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "Match or beat it for a trophy; finish close to it for gold or silver. Any solve earns bronze.",
        ...
        "tier_silver": "Silver",
        "tier_bronze": "Bronze",
        "tier_keep": "{tier}: finish in {n} moves or fewer to keep it",
        "tier_over_one": "{tier}: {over} move over the challenge of {n}.",
        "tier_over_other": "{tier}: {over} moves over the challenge of {n}.",
        "share_prompt": "Can you do better?",
    ...
    "pt-BR": {
        ...
        "Iguale ou supere para ganhar um troféu; termine perto dele para ouro ou prata. Qualquer solução vale bronze.",
        ...
        "tier_silver": "Prata",
        "tier_bronze": "Bronze",
        "tier_keep": "{tier}: termine em até {n} movimentos para mantê-lo",
        "tier_over_one": "{tier}: {over} movimento acima do desafio de {n}.",
        "tier_over_other": "{tier}: {over} movimentos acima do desafio de {n}.",
        "share_prompt": "Consegue fazer melhor?",
